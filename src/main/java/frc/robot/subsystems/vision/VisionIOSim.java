...
//         Optional<Pose3d> frontPose = visionSim.getCameraPose(frontCameraSim);
//         return frontPose.isPresent() ? frontPose.get() : null;
//     }

//     @Override
//     public Pose3d getBackPose() {
//         Optional<Pose3d> backPose = visionSim.getCameraPose(backCameraSim);
//         return backPose.isPresent() ? backPose.get() : null;
//     }
// }